...
Thanks for your interest in `@nomercy-entertainment/nomercy-music-player`. This package is the v2 music player package built on the NoMercy player kit.

## Reporting issues

- Bug? File a [GitHub issue](https://github.com/NoMercy-Entertainment/nomercy-music-player/issues) with a minimal reproduction. Include kit version, browser, and a stack trace if you have one.
